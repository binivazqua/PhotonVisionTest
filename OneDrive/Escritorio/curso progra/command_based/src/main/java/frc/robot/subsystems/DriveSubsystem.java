...
public class DriveSubsystem extends SubsystemBase {
  ...
  static WPI_TalonSRX motor1 = new WPI_TalonSRX(1);
  static WPI_TalonSRX motor2 = new WPI_TalonSRX(3);
  static WPI_VictorSPX motor3 = new WPI_VictorSPX(4);
  static WPI_VictorSPX motor4 = new WPI_VictorSPX(2);
